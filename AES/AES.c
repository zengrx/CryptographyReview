...
#include "test.h"
    ...
    aes_encrypt_cfb8(AES_CYPHER_128, anni_buf1, sizeof(anni_buf1), key, iv, 1);
    aes_encrypt_cfb8(AES_CYPHER_128, anni_buf1, sizeof(anni_buf1), key, iv, 0);
...
#define AES_OFB
    ...
    // uint8_t anni_buf[] = "this is a test messageeee...";
